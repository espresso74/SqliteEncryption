...
namespace Demo.Encrypt
{
    ...
    /// The task is to encrypt and decrypt user passwords with the AES CBC algorithm using an AES 256bit cryptographic key. 
    /// The key is generated from a combination of password and randomly generated salt using a PBKDF2 derived key algorithmic function.  
    /// </summary>    
    public static class AES256CryptoEngine
    {
        /// <summary>    
